<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM agendamentos WHERE id LIKE '%$data%' or nome LIKE '%$data%' or email LIKE '%$data%' ORDER BY id DESC";
    }
    else
    {
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>".$user_data['empreendimento']."</td>";
                        echo "<td>".$user_data['data']."</td>";
                        echo "<td>".$user_data['horario']."</td>";
                        echo "<td>
                            <a class='btn btn-sm btn-danger' href='deleteVisitas.php?id=$user_data[id]' title='Deletar'>
