<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM saq WHERE id LIKE '%$data%' or nome LIKE '%$data%' or email LIKE '%$data%' ORDER BY id DESC";
    }
    else
    {
        $sql = "SELECT * FROM saq ORDER BY id ASC";
    }
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                            <a class='btn btn-sm btn-danger' href='deleteSAQ.php?id=$user_data[id]' title='Deletar'>
